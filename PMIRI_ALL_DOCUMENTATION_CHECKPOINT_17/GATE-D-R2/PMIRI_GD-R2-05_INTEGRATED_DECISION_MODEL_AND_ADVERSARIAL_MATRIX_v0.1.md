...
The integrated schema revision is `0.2`. Cross-record equality that cannot be
...
`content_lifecycle=NOT_APPLICABLE` and null lifecycle references.
...
schemas plus `PMIRI_GD-R2_CROSS_FIELD_VALIDATION_RULES_v0.4.md`:
