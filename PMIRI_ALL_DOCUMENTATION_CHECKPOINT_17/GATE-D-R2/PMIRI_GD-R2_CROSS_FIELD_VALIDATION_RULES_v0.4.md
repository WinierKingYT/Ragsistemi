...
# Cross-Field Validation Rules v0.4
...
`admission_state`, `retrieval_visibility`, terminal fingerprint and epochs.
...
The canonicalization profile is normative: HTTPS is lowercased; only port 443
