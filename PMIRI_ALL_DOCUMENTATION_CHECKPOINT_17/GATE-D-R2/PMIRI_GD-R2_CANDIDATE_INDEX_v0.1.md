...
**Version:** 0.4  
**Status:** `D2 CANDIDATE / FIX-FIRST / CORRECTION REVISION 0.4 / INDEPENDENT RECHECK REQUIRED`  
...
- The independent documentary reviewer returned `FIX-FIRST`; findings
  `IR-D2-01` through `IR-D2-22` are structurally addressed in correction
  revision `0.4` and await a new independent recheck. This is not an
  acceptance claim.
...
`PMIRI_GD-R2_CORRECTIVE_CLOSURE_REPORT_v0.4.md`; the cross-field rules are
recorded in `PMIRI_GD-R2_CROSS_FIELD_VALIDATION_RULES_v0.4.md`. The next task
...
`PMIRI_GD-R2_INDEPENDENT_REVIEW_DECISION_v0.3.md`; the fresh pass that
preceded them is recorded in
`PMIRI_GD-R2_INDEPENDENT_HARD_RECHECK_REPORT_v0.1.md`.

The new review must follow
`PMIRI_GD-R2_INDEPENDENT_RECHECK_COMMISSION_v0.4.md` and produce a separate
